...
export async function registerV2ContextPackRoutes(server: FastifyInstance, deps: ApiDependencies): Promise<void> {
  server.get<{ Params: ContextPackParams }>("/api/v2/context-packs/:id", async (request, reply) => {
