...
describe("useTimeline", () => {
  ...
  it("loads SQLite events and polls from the last cursor without duplicates", async () => {
    vi.useFakeTimers();
    const first = { id: "evt_1", workspaceId: "w_1", type: "workspace.created", actor: "user" as const, title: "Created", payload: {}, privacy: {}, createdAt: "2026-07-10T12:00:00.000Z", citations: [] };
    const second = { ...first, id: "evt_2", type: "user.message.created", title: "Message", createdAt: "2026-07-10T12:01:00.000Z" };
